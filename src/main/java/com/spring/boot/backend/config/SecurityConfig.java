/*
 * package com.spring.boot.backend.config;
 * 
 ...
 * import org.springframework.security.core.session.SessionRegistry; import
 ...
 * 
 * @Import(KeycloakSpringBootConfigResolver.class) public class SecurityConfig
 ...
 * throws Exception { KeycloakAuthenticationProvider authenticationProvider =
 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @Bean protected SessionRegistry buildSessionRegistry() { return new
		 * SessionRegistryImpl(); }
		 * 
		 * @Override protected void configure(HttpSecurity http) throws Exception {
		 * super.configure(http); http.csrf().disable().authorizeRequests()
		 * .anyRequest().permitAll(); //.antMatchers("/api/v1/*").hasRole("user")
		 * //.antMatchers("/api/v1/*").hasRole("admin") //.anyRequest().permitAll(); } }
		 */